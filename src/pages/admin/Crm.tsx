...
export default function CrmPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">CRM do restaurante</h1>
        <p className="text-muted-foreground">Clientes, fornecedores, contas a pagar, notas fiscais e histórico de alterações.</p>
      </div>
